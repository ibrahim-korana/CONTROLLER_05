...
class Dali  {
    public:
        ...
        backword_tt send_receive(package_t *package);
        backword_t ysend_receive(package_t *package);

        bool busy_is_wait(void) {return false;}
    ...
    private:
        ...
        backword_tt _esend_receive(package_t *package);
        ...
        */
        ...
        gptimer_handle_t kom_timer = NULL;
         QueueHandle_t queue = xQueueCreate(160, sizeof(example_queue_element_t));
